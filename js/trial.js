 ...
 function draw(selector, url, space = 450){
    //code here      
               
 var svg = d3.select(selector),
 margin = {top: 20, right: 350, bottom: 200, left: 50},
    margin2 = { top: 430, right: 10, bottom: 150, left: 40 },
...
var minY; // Defined to update yAxis later with min to max value //
...
d3.csv(url, function(error, data) { 
 ...
 var brush = d3.svg.brush()//for slider bar at the bottom
  ...
  // draw legend
  var legendSpace = space / categories.length; // 450/number of issues (ex. 40)    
